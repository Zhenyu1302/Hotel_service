...
class SimpleMonitor(simple_switch_13.SimpleSwitch13):
    ...
    def byte_count_reset(self,datapath,recover_eth_dst):
        ...
        actions = [parser.OFPActionOutput(ofproto.OFPFF_RESET_COUNTS,0)]
        inst = [parser.OFPInstructionActions(ofproto.OFPIT_APPLY_ACTIONS,
                                             actions)]
    ...
    def traffic_control(self,datapath,drop_eth_dst,flags):
        if flags == 0:
            ...
            self.byte_count_reset(datapath,drop_eth_dst)
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        for stat in sorted([flow for flow in body if flow.priority == 1],
            ...
            elif stat.byte_count > 200 and stat.match['eth_dst'] in self.traffic:
                self.traffic_control(ev.msg.datapath,stat.match['eth_dst'],1)
            else:
                continue
